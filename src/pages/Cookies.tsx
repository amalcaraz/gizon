...
export const Cookies: React.FC = () => {
  return (
    <Wrapper>
      <PageMeta id={RouteId.COOKIES} />
      <Container>
        <h1>POLÍTICA DE COOKIES</h1>

        <Section>
          <Title>www.gizon-moda.com</Title>
        ...
        <Section>
          ...
          <p>Son aquellas cookies que son enviadas al ordenador o dispositivo del Usuario y gestionadas exclusivamente por Moda Hombre para el mejor funcionamiento del Sitio Web. La información que se recaba se emplea para mejorar la calidad del Sitio Web y su Contenido y su experiencia como Usuario. Estas cookies permiten reconocer al Usuario como visitante recurrente del Sitio Web y adaptar el contenido para ofrecerle contenidos que se ajusten a sus preferencias.</p>
        </Section>
